---
description: Turn an idea for a new Dumpo capability (or a substantial change) into a spec'd, implemented, tested addition (alias for the zero-shot-build skill).
